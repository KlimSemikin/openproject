...
import { TableEventComponent, TableHandlerRegistry } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/handlers/table-handler-registry';
...
@Component({
  ...
  selector: 'table-hierarchical-list',
})

export class HierarchicalTableListComponent extends UntilDestroyedMixin implements OnInit, TableEventComponent {
  ...
  ngOnInit():void {
    ...
    statesCombined.pipe(
     ...
     // this.columns = columns;
      this.columns = [{ custom_field: 'Значение', name: 'Значение' }, { custom_field: 'Описание', name: 'Описание' }];
