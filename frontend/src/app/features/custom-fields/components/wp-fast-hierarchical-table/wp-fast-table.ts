...
export class WorkPackageTable {
  ...
  // private buildIndex(rows:NestedOptionResource[]) {
  //   this.originalRowIndex = {};
  //   this.originalRows = rows.map((wp:NestedOptionResource, i:number) => {
  //     const wpId = wp.id!;
  //
  //     // Ensure we get the latest version
  //     wp = this.apiV3Service.custom_nested_options.cache.current(wpId, wp)!;
  //
  //     this.originalRowIndex[wpId] = <WorkPackageTableRow>{ object: wp, workPackageId: wpId, position: i };
  //     return wpId;
  //   });
