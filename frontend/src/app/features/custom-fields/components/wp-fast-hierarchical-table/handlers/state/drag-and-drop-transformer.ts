...
import { isInsideCollapsedGroup } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/helpers/wp-table-row-helpers';
import { collapsedGroupClass } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/helpers/wp-table-hierarchy-helpers';
