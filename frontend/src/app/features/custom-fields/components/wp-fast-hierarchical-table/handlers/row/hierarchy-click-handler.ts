...
import { TableEventComponent, TableEventHandler } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/handlers/table-handler-registry';
