...
import { scrollTableRowIntoView } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/helpers/wp-table-row-helpers';
import {
...
import {
  ...
  hierarchyGroupClass,
  hierarchyRootClass,
} from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/helpers/wp-table-hierarchy-helpers';
import { indicatorCollapsedClass } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/builders/modes/hierarchy/single-hierarchy-row-builder';
import { tableRowClassName } from 'core-app/features/custom-fields/components/wp-fast-hierarchical-table/builders/rows/single-row-builder';
