...
@Component({
  selector: 'hierarchical-list-view',
  templateUrl: './hierarchical-list-view.html',
  styleUrls: ['./hierarchical-list-view.sass'],
...
export class HierarchicalListViewComponent extends UntilDestroyedMixin implements OnInit {
  text = {
