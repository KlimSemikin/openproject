...
import { TableEventComponent, TableHandlerRegistry } from 'core-app/features/catalog-items/components/ci-fast-table/handlers/table-handler-registry';
  ...
  ngOnInit():void {
    ...
    statesCombined.pipe(
     ...
     // this.columns = columns;
      this.columns = [{ custom_field: 'ID', name: 'ID' }, { custom_field: 'Значение', name: 'Значение' }, { custom_field: 'Описание', name: 'Описание' }];
