...
import { rowGroupClassName } from 'core-app/features/catalog-items/components/ci-fast-table/builders/modes/grouped/grouped-classes.constants';
import { locatePredecessorBySelector } from 'core-app/features/catalog-items/components/ci-fast-table/helpers/wp-table-row-helpers';
import { groupIdentifier } from 'core-app/features/catalog-items/components/ci-fast-table/builders/modes/grouped/grouped-rows-helpers';
