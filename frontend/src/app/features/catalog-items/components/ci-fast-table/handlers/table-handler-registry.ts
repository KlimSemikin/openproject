...
import { HighlightingTransformer } from 'core-app/features/catalog-items/components/ci-fast-table/handlers/state/highlighting-transformer';
import { DragAndDropTransformer } from 'core-app/features/catalog-items/components/ci-fast-table/handlers/state/drag-and-drop-transformer';
import {
...
import { GroupFoldTransformer } from 'core-app/features/catalog-items/components/ci-fast-table/handlers/state/group-fold-transformer';
