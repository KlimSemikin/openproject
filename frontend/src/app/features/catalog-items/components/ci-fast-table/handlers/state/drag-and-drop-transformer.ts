...
import { isInsideCollapsedGroup } from 'core-app/features/catalog-items/components/ci-fast-table/helpers/wp-table-row-helpers';
import { collapsedGroupClass } from 'core-app/features/catalog-items/components/ci-fast-table/helpers/wp-table-hierarchy-helpers';
