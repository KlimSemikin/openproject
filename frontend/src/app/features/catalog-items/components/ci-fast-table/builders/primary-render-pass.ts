...
import { HighlightingRenderPass } from 'core-app/features/catalog-items/components/ci-fast-table/builders/highlighting/row-highlight-render-pass';
import { DragDropHandleRenderPass } from 'core-app/features/catalog-items/components/ci-fast-table/builders/drag-and-drop/drag-drop-handle-render-pass';
