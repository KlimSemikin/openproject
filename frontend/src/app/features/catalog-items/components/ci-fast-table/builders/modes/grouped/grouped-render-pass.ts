...
import { collapsedRowClass } from 'core-app/features/catalog-items/components/ci-fast-table/builders/modes/grouped/grouped-classes.constants';
import { GroupSumsBuilder } from 'core-app/features/catalog-items/components/ci-fast-table/builders/modes/grouped/group-sums-builder';
