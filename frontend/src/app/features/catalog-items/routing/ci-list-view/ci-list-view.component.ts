...
@Component({
  selector: 'ci-list-view',
  templateUrl: './ci-list-view.html',
  styleUrls: ['./ci-list-view.sass'],
...
export class CiListViewComponent extends UntilDestroyedMixin implements OnInit {
  text = {
