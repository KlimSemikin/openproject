...
import { OpenprojectCatalogItemsRoutesModule } from 'core-app/features/catalog-items/openproject-catalog-items-routes.module';
...
@NgModule({
  imports: [
    ...
    OpenprojectCatalogItemsRoutesModule,
  ],
  providers: [
